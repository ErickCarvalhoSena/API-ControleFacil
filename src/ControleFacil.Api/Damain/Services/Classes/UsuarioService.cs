...
namespace ControleFacil.Api.Damain.Services.Classes
{
    public class UsuarioService : IUsuarioService
    {
        ...
        {
           _ = await Obter(id) ?? throw new Exception("Usuario não encontrado para atualizar");
        ...
        {
            var usuario = await _usuarioRepository.Obter(id) ?? throw new Exception("Usuario não encontrado para invativar");
